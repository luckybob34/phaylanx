# PPTX Components — Credera

Reference for available component renderers in the Credera PPTX theme.

> The PPTX template file (`template.pptx`) is a binary asset stored at `template.pptx` (in this directory) (83MB+, gitignored). The config below and the template together drive `render_pptx.py`.
